  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      case AppRoutes.products:
        return MaterialPageRoute(builder: (_) => ProductListPage(), settings: settings);

      case AppRoutes.productsNew:
        return MaterialPageRoute(builder: (_) => Placeholder(), settings: settings);

      case AppRoutes.productEdit:
        final args = settings.arguments;
        return args! is String
            ? _barArgs('Se esperaba el id del producto.')
            : MaterialPageRoute(builder: (_) => Placeholder(), settings: settings);
      default:
